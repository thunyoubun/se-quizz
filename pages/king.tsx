...
const king = () => {
  return (
    <body className="">
      ...
      <div className="w-full  right-0  container mt-40    px-7 z-10">
        <div className=" border-3 border-black rounded-md p-4 z-10 overflow-y-auto bg-white shadow-lg">
          <div className=" mt-3 px-6 w-full flex justify-between relative">
            <h1 className=" text-lg font-semibold text-gray-600">My Quizz</h1>
