  ...
  return (
    <div className="relative min-h-screen flex ">
      <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
        ...
        <div className="md:flex md:items-center md:justify-center md:my-0 h-full flex items-center justify-center sm:w-2/5 sm:h-screen md:h-full w-full xl:w-2/5 sm:p-1  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none md:bg-white bg-blue-500">
          <div className="max-w-md w-full bg-white space-y-8 shadow-lg border sm:border-none rounded-xl px-4 sm:px-0 sm:shadow-none">
